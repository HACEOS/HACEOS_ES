classdef interruptor_sencillo < hcs.interruptor
...
%
% See also interruptor, interruptor_compuesto, formato_caso
...
%   Nota: este archivo es libre de tildes para evitar posibles conflictos en sistemas sin codificacion UTF-8
    ...
    methods
        ...
        function [caso_nuevo,memoria] = evaluar(obj,caso,memoria)
            ...
            caso_nuevo = caso;
            if obj.estado == 1
                nodo_menor = min(obj.term1,obj.term2);
                nodo_mayor = max(obj.term1,obj.term2);
